...
const getPasswordbyID = document.getElementById("password");
if(getPasswordbyID !== null){
    getPasswordbyID.addEventListener("keyup", (event) => {
...
// Re-Enter Password
const getReenterPassword = document.getElementById("reenterpassword");
if(getReenterPassword !== null){
    getReenterPassword.addEventListener("keyup", (event) => {
